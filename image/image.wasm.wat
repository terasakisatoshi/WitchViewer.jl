(module
 ...
 (type $7 (func (param externref i32 i32)))
 (type $8 (struct (field f64)))
 (type $9 (struct (field f32)))
 (type $10 (struct (field (ref null $2))))
 (type $11 (struct (field i64)))
 (type $12 (array (mut (ref null $1))))
 (type $13 (struct (field (mut (ref null $12))) (field (mut i32))))
 (type $14 (array (ref null $1)))
 (type $15 (func (param i32) (result externref)))
 (type $16 (struct (field (ref null $1)) (field i32) (field f64)))
 ...
 (import "js" "(v, i, x) => v[i] = x" (func $_v__i__x_____v_i____xNothingExternrefInt32UInt8 (type $7) (param externref i32 i32)))
 ...
 (import "js" "(v, i, x) => v[i] = x" (func $_v__i__x_____v_i____xNothingExternrefInt32Int32 (type $7) (param externref i32 i32)))
 (import "js" "(v, i, x) => v[i] = x" (func $_v__i__x_____v_i____xNothingExternrefInt32Externref (type $23) (param externref i32 externref)))
 (import "js" "(v, i, x) => v[i] = x" (func $_v__i__x_____v_i____xNothingExternrefInt32Bool (type $7) (param externref i32 i32)))
 ...
 (func $julia__setExternrefInt32UInt8 (type $7) (param $0 externref) (param $1 i32) (param $2 i32)
  (local $3 i32)
  (block
   (local.set $3
    (i32.sub
 ...
 (func $julia_objectVector_Any_ (type $24) (param $0 (ref null $4)) (result externref)
  ...
  (local $54 i32)
  (local $55 i32)
  (local $56 (ref null $10))
  (local $57 (ref null $2))
  (local $58 externref)
  (local $59 i32)
  (local $60 i32)
  (local $61 (ref null $11))
  (local $62 i64)
  (local $63 i32)
  (local $64 i32)
  (local $65 i32)
 ...
 (func $update (type $27)
  ...
  (local $16 (ref null $14))
  (local $17 (ref null $13))
  (local $18 (ref null $1))
  (local $19 i64)
  (local $20 i32)
  (local $21 i64)
